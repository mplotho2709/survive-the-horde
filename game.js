...
const WEAPONS = [
  ...
  },
  {
    ...
    statA: 'CD: 6  ·  DMG: 0.5',
    statB: 'Short range',
    fireCD: 6, damage: 0.5, bulletSize: 3, pierce: 0,
    burstCount: 1, spreadAngle: 0, bulletSpeed: BULLET_SPEED,
  ...
  },
  {
    ...
    bulletLifetime: 46, maxBulletLifetime: 92,
    maxDamage: 2.5, maxBulletSize: 6,
  },
  {
    ...
    statA: 'CD: 55  ·  DMG: 4',
    statB: 'Extreme range, pierce',
    fireCD: 55, damage: 4, bulletSize: 3, pierce: 1,
    burstCount: 1, spreadAngle: 0, bulletSpeed: BULLET_SPEED * 3.0,
    bulletLifetime: 110, maxBulletLifetime: 220,
    maxDamage: 9,   maxBulletSize: 5,
  },
  {
    id: 'cannon', name: 'Cannon', color: '#c39bd3',
    tag: 'Huge slow slug, pierce ×3',
    statA: 'CD: 60  ·  DMG: 5',
    statB: 'Medium range, pierce ×3',
    fireCD: 60, damage: 5, bulletSize: 10, pierce: 2,
    burstCount: 1, spreadAngle: 0, bulletSpeed: BULLET_SPEED * 0.6,
    bulletLifetime: 130, maxBulletLifetime: 260,
    maxDamage: 11,  maxBulletSize: 14,
  },
];
